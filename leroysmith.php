...
// Busca o personagem
$sql_personagem = "SELECT personagem_id, personagem_nome, personagem_img FROM alansteindorff_personagem WHERE personagem_nome = 'Leroy Smith' LIMIT 1";
                ...
                <table class="move-frames">
                  <?php if (isset($_SESSION['usuarioNiveisAcessoId']) && ($_SESSION['usuarioNiveisAcessoId'] == 1 || $_SESSION['usuarioNiveisAcessoId'] == 2)): ?>
                    <div class="btn-edit-move" style="display: flex; gap: 8px;">
                      <a href="editar_golpe.php?id=<?= $golpe['golpe_id'] ?>&voltar=leroysmith.php" class="goto-btn edit-btn">
